...
export default Tabs;
    ...
    // the component keeps track of which tab is active, content for each tab, and displays a list of tabs. 
    // the tabs component uses the next component you will create called "Tab"